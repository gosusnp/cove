...
func TestUserHandler_Logout(t *testing.T) {
	t.Run("success deletes current session", func(t *testing.T) {
		...
		token, err := app.Users.CreateSession(context.Background(), userID, "1.2.3.4", "agent", "OS")
		if err != nil {
...
func TestUserHandler_Sessions(t *testing.T) {
	...
	t.Run("cannot list another user's sessions", func(t *testing.T) {
		...
		_, _ = app.Users.CreateSession(context.Background(), userA, "1.1.1.1", "agent", "OS")
	...
	t.Run("cannot delete another user's session", func(t *testing.T) {
		...
		tokenA, _ := app.Users.CreateSession(context.Background(), userA, "1.1.1.1", "agent", "OS")
